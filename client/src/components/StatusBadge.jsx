const STATUS = {
  new:               { label: 'جديد',             bg: 'rgba(100, 116, 139, 0.10)', fg: '#64748B'  },
  received:          { label: 'مستلمة',           bg: 'rgba(41, 128, 185, 0.10)',  fg: '#2980B9'  },
  inspection:        { label: 'قيد الفحص',         bg: 'rgba(124, 58, 237, 0.10)', fg: '#7C3AED'  },
  ...
  ready_for_return:  { label: 'جاهزة للإرجاع',    bg: 'rgba(22, 163, 74, 0.10)',  fg: '#16A34A'  },
  returned_to_shop:  { label: 'وصلت للفرع',        bg: 'rgba(5, 150, 105, 0.10)',  fg: '#059669'  },
  ...
  diagnosing:       { label: 'قيد الفحص',          bg: 'rgba(124, 58, 237, 0.10)', fg: '#7C3AED'  },
